...
class Application(tk.Frame):
    def __init__(self, master=None):
        ...
        self.explore_mode = tk.IntVar(value=0) # 设为双人
        self.gouliang_1 = tk.BooleanVar(value=True)
        self.gouliang_2 = tk.BooleanVar(value=False)
        self.gouliang_3 = tk.BooleanVar(value=True)
        self.gouliang_4 = tk.BooleanVar(value=True)
        self.gouliang_5 = tk.BooleanVar(value=True)
        ...
        self.watchdog_enable.set(False)
